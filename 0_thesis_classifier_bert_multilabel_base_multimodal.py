        ...
        for dropoutrate1 in [0.2, 0.5]:
            for dropoutrate2 in [0.0, 0.2]:
                for batchsize in [16, 32]:
                    ...
                    avg_loss, avg_f1_micro, avg_f1_per_category, avg_accuracy, f1_range = cross_validate(model_name=modelname, df=df, abstract_column=abstract_column, 
                    ...
                    with open(f'performance_dict_multimodal_{multilabel}_base_{timestamp}.json', 'w') as f:
